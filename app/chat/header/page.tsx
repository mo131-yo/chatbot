  ...
  return (
    <>
      ...
      >
        ...
        {cartCount > 0 && (
          <span className="absolute -top-1 -right-1 flex h-5 w-5 items-center justify-center rounded-full bg-[#C5A059] text-[10px] font-black text-black ring-2 ring-[#0D0D0D] animate-in zoom-in">
            {cartCount}
          </span>
        )}
      </button>
