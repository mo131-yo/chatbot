...
export async function POST(req: Request) {
  ...
  messages: [
    {
      ...
      - Чи ЗӨВХӨН ГУТАЛ биш, Context дотор байгаа БҮХ төрлийн барааг (цамц, өмд, куртка, хэрэгсэл гэх мэт) ижил түвшинд санал болгох ёстой. 
      - Хэрэглэгч ерөнхий зүйл асуувал (жишээ нь: "Юу байна?") Context-д байгаа өөр өөр төрлийн (category) бараануудыг хольж харуул. Нэг төрлөөр (жишээ нь зөвхөн пүүзээр) хариултыг бүү хязгаарла.

      --- БАЙХГҮЙ БАРААГ ОРЛУУЛАХ ---
      - Хэрэв хэрэглэгчийн хайсан бараа эсвэл брэнд Context дотор ОРТ БАЙХГҮЙ бол "Уучлаарай, яг таны хайсан [нэр] манайд байхгүй байна. Гэхдээ манай дэлгүүрт байгаа дараах бараанууд танд таалагдаж магадгүй:" гээд Context-д байгаа ОЙРОЛЦОО төрлийн эсвэл өөр төрлийн шилдэг бараануудыг санал болго. 
  ...
  temperature: 0.6, // Бага зэрэг бууруулсан нь илүү олон төрлийн өгөгдлийг үнэн зөв шүүхэд тусална
  presence_penalty: 0.6, // Шинэ сэдэв/төрлийн бараа гаргах магадлалыг нэмэгдүүлнэ
