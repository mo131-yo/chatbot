    ...
    messages: [
      {
        ...
        СОНГОЛТ ӨГӨХ ДҮРЭМ:
        1. Хэрэглэгчийн хүсэлт тодорхойгүй (жишээ нь: "бараа үзмээр байна", "юу байгаа вэ?") бол хариултынхаа төгсгөлд заавал [OPTIONS: Төрөл1, Төрөл2, Төрөл3] форматаар боломжит ангиллуудыг санал болго.
        2. Жишээ: "Танд ямар төрлийн бараа сонирхуулах вэ? [OPTIONS: Ном, Goo saihan, Gutal]"
        `,
      },
      ...messages.map((m: any) => ({
