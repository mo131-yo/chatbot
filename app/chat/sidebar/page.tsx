"use client";
import { NewChatBtn, ChatHistory } from "./components"; // Зам заагчийг өөрийнхөөрөө тааруулаарай
...
interface SidebarProps {
  ...
  isLoading?: boolean; // Load төлөвийг харуулах бол
}

export default function Sidebar({ isCollapsed, history, onNewChat, onSelectChat, isLoading }: SidebarProps) {
  return (
    <aside 
